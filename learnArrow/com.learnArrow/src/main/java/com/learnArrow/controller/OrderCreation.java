...
import com.learnArrow.services.StudentService;
import com.learnArrow.services.TrainerService;
...
public class OrderCreation {
	...
	public String takeOrder(@RequestParam int amount,
		...
		Order order=null;
		try {
			  RazorpayClient razorpay=new RazorpayClient("rzp_test_ANiFbfIjOIx3EF",
					  										"jgHc0g5bAebbeilwWX1uXP45");
